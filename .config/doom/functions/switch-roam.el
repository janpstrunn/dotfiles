(defun org-roam-switch-db (&optional arg silent)
  ...
  (setq org-roam-directory (file-truename (concat "~/org/" org-roam-db-choice "/"))
        org-roam-db-location (file-truename (concat "~/org/" org-roam-db-choice "/org-roam.db"))
        org-directory (file-truename (concat "~/org/" org-roam-db-choice "/")))
  (when (not silent))
